# Small script to display Raspberry Pi system stats on an OLED display
# Requires: adafruit-circuitpython-ssd1306, psutil, Pillow
# Tested on Raspberry Pi 5 with SSD1306 OLED display
# ==== ==== ==== ==== ==== ==== ==== ====
...
try:
    while True:
        ...
        y_offset += 15
        # NETWORK
        draw.text((0, y_offset), f"NET {download_speed:.1f}/{upload_speed:.1f} KB/s", font=font, fill=255)
        # UPDATE DISPLAY
        oled.image(image)
        oled.show()
        time.sleep(5)
